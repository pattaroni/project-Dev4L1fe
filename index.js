import{a as f,S as w,i as h}from"./assets/vendor-F9iMMrrb.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const t of document.querySelectorAll('link[rel="modulepreload"]'))n(t);new MutationObserver(t=>{for(const r of t)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function i(t){const r={};return t.integrity&&(r.integrity=t.integrity),t.referrerPolicy&&(r.referrerPolicy=t.referrerPolicy),t.crossOrigin==="use-credentials"?r.credentials="include":t.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(t){if(t.ep)return;t.ep=!0;const r=i(t);fetch(t.href,r)}})();const L={BASE_URL:"https://sound-wave.b.goit.study/api",ENDPOINTS:{genres:()=>"/genres",artists:()=>"/artists",artistById:e=>`/artists/${e}`,artistByIdWithAlbums:e=>`/artists/${e}/albums`,feedbacks:()=>"/feedbacks"},PER_PAGE:8},{BASE_URL:S,ENDPOINTS:b,PER_PAGE:v}=L;f.defaults.baseURL=S;const E=async({page:e=1,genre:s,name:i,sortName:n}={})=>{const{data:t}=await f.get(b.artists(),{params:{page:e,limit:v,...!!s&&{genre:s},...!!i&&{name:i},...!!n&&{sortName:n}}}),r=t.totalArtists||0,a=e>=Math.ceil(r/v);return{data:t,isLastPage:a}},k=async(e=1,s=10)=>{const{data:i}=await f.get(b.feedbacks(),{params:{page:e,limit:s}}),n=i.data||[],t=i.total||0,r=e>=Math.ceil(t/s);return{feedbacks:n,isLastPage:r}},g={artistsList:document.querySelector(".artists-list"),containerEL:document.querySelector(".container"),loader:document.querySelector(".loader")},A=(e="")=>CSS.supports("-webkit-line-clamp","2")&&CSS.supports("display","-webkit-box")?e:e.length>80?e.slice(0,80).trim()+"...":e,o={create(e){return e?(e.insertAdjacentHTML("beforeend",'<span class="loader hidden"></span>'),e.querySelector(".loader")):void 0},show(e){e?.classList.remove("hidden")},hide(e){e?.classList.add("hidden")}},u="/project-Dev4L1fe/assets/sprite-D03_Ml0c.svg";function $(e){const s=e.map(i=>{const n=i.genres.map(r=>`<li class="genres-list-item">${r}</li>`).join(""),t=A(i.strBiographyEN);return`<li class="artists-list-item" data-id="${i._id}">
